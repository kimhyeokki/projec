...
%>
    <div class="container">
      <form action="../member/edit-member-process" method="post" class="" name="member"
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-6">
            <div class="mb-3">
              ...
              placeholder="user name" name="userName" value="${editmember.userName }"/>
            </div>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-6">
            <div class="mb-3">
              ...
              placeholder="post code" name="postCode" value="${editmember.postcode }"/>
              <div>
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-6">
            <div class="mb-3">
              ...
              name="address" placeholder="address" value="${editmember.address }"/>
            </div>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
