		...
		<div class="col-10">
			...
			<div class="d-flex justify-content mt-5">
					<nav aria-label="Page navigation example">
  						<ul class="pagination">
						    <li class="page-item"><a class="page-link" href="../board/view?no=${preBoard.no }&num=${preBoard.num }">이전글 : ${preBoard.title }</a></li>
						    <li class="page-item"><a class="page-link" href="../board/view?no=${nextBaord.no }&num=${nextBaord.num}">다음글 : ${nextBaord.title }</a></li>
  						</ul>
					</nav>
			</div>
